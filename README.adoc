...
Le projet sera réalisé par des groupes de 4 étudiants. Seulement si le nombre d'étudiants actifs dans ce cours n'est pas un multiple de 4, alors des groupes de 5 seront exceptionellement possibles.
